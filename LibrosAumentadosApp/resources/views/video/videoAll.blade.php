...
<div class="row">
                <div class="col-lg-12">
                    <!-- ... Titulo de la pagina ... -->
                    <h1 class="page-header">Lista de videos</h1>
                ...
                <div class="col-md-6">
                    <div class="hero-widget well well-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-sm-6 options">
                                <a onclick="vb{{$dato->id}}()" class="btn btn-danger btn-lg btn-block btn-sm"><i class="fa fa-minus"></i> Borrar</a>
                            </div>
                ...
                <script>
                                function vb{{$dato->id}}(){
                                        ...
                                        modal.addFooterBtn('Borrar', 'tingle-btn tingle-btn--danger', function() {
                                            // here goes some logic
                                            modal.close();
                                            window.location.href="{{route('video.delete', $dato->id)}}";
                                        });
                                        // open modal
                                        modal.open();
                                    }
