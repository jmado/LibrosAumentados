                ...
                <div class="col-sm-12">
                    <div class="hero-widget well well-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col col-sm-6 options">
                                <a href="{{ route('imagen.createAdmin') }}" class="btn btn-primary btn-lg btn-block"><i class="glyphicon glyphicon-plus"></i> Nuevo</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="hero-widget well well-sm">
                        ...
                        <div class="row">
                            <div class="col col-sm-6 options">
                                <a href="{{route('imagen.editAdmin', $dato->id)}}" class="btn btn-warning btn-lg btn-block btn-sm"><i class="fa fa-pencil"></i> Modificar</a>
                            </div>
                            <div class="col col-sm-6 options">
                            ...
                            <div class="col col-sm-12 options">
                                <a href="{{URL::asset($dato->imagen)}}" class="btn btn-primary btn-lg btn-block btn-sm"><i class="fa fa-eye"></i> Ver</a>
                            </div>
